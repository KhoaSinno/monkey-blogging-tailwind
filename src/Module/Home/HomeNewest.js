          ...
          <div className="grid grid-rows-3 gap-y-7 bg-[#F3EDFF] px-6 py-5 rounded-xl">
            <div className="cart-item-row h-[180px] overflow-y-auto ">
              <NavLink className='flex gap-x-3'>
                ...
                <div className="w-2/3">
                  <PostCategory bgColor='secondary'>Knowledge</PostCategory>
                  <PostTitle className='text-xl font-medium py-3'>This revision improves the sentence structure and conveys the idea more effectively. This revision improves the sentence structure and conveys the idea more effectively.</PostTitle>
